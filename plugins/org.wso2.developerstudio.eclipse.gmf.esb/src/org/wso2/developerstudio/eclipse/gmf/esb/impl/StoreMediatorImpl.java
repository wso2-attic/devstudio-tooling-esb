...
public class StoreMediatorImpl extends MediatorImpl implements StoreMediator {
	...
	/**
	 * The default value of the '{@link #getAvailableMessageStores() <em>Available
	 * Message Stores</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getAvailableMessageStores() <em>Available
	 * Message Stores</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @see #getAvailableMessageStores()
