...
public class EsbPackageImpl extends EPackageImpl implements EsbPackage {
	...
	public EReference getInboundEndpoint_ServiceParameters() {
		return (EReference)inboundEndpointEClass.getEStructuralFeatures().get(142);
	}
	 ...
	 * @generated
	 */
	public EAttribute getInboundEndpoint_Wso2mbConnectionUrl() {
	 ...
	 * @generated
	 */
	public EAttribute getInboundEndpoint_TransportJMSSharedSubscription() {
	 ...
	 * @generated
	 */
	public EAttribute getInboundEndpoint_TransportJMSSubscriptionName() {
	 ...
	 * @generated
	 */
	public EAttribute getInboundEndpoint_TransportJMSPinnedServers() {
	 ...
	 * @generated
	 */
	public EAttribute getInboundEndpoint_TransportJMSConcurrentConsumers() {
	 ...
	 * @generated
	 */
	public EAttribute getInboundEndpoint_TransportJMSRetryDuration() {
	...
	public void createPackageContents() {
		...
		createEAttribute(inboundEndpointEClass, INBOUND_ENDPOINT__WSO2MB_CONNECTION_URL);
		...
		createEAttribute(inboundEndpointEClass, INBOUND_ENDPOINT__TRANSPORT_JMS_SHARED_SUBSCRIPTION);
		createEAttribute(inboundEndpointEClass, INBOUND_ENDPOINT__TRANSPORT_JMS_SUBSCRIPTION_NAME);
		createEAttribute(inboundEndpointEClass, INBOUND_ENDPOINT__TRANSPORT_JMS_PINNED_SERVERS);
		...
		createEAttribute(inboundEndpointEClass, INBOUND_ENDPOINT__TRANSPORT_JMS_CONCURRENT_CONSUMERS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAbstractEndPoint_TimeOutDuration(), ecorePackage.getEString(), "timeOutDuration", "0", 0, 1, AbstractEndPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCacheMediator_CacheProtocolMethods(), ecorePackage.getEString(), "cacheProtocolMethods", null, 0, 1, CacheMediator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCacheMediator_ResponseCodes(), ecorePackage.getEString(), "responseCodes", null, 0, 1, CacheMediator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInboundEndpoint_Wso2mbConnectionUrl(), ecorePackage.getEString(), "wso2mbConnectionUrl", null, 0, 1, InboundEndpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInboundEndpoint_TransportJMSSharedSubscription(), ecorePackage.getEBoolean(), "transportJMSSharedSubscription", "false", 0, 1, InboundEndpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInboundEndpoint_TransportJMSSubscriptionName(), ecorePackage.getEString(), "transportJMSSubscriptionName", null, 0, 1, InboundEndpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInboundEndpoint_TransportJMSPinnedServers(), ecorePackage.getEString(), "transportJMSPinnedServers", null, 0, 1, InboundEndpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInboundEndpoint_TransportJMSConcurrentConsumers(), ecorePackage.getEString(), "transportJMSConcurrentConsumers", null, 0, 1, InboundEndpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInboundEndpoint_SocketTimeoutMs(), ecorePackage.getEString(), "socketTimeoutMs", "", 0, 1, InboundEndpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(artifactTypeEEnum, ArtifactType.ENDPOINT_ADDRESS);
		addEEnumLiteral(artifactTypeEEnum, ArtifactType.ENDPOINT_DEFAULT);
