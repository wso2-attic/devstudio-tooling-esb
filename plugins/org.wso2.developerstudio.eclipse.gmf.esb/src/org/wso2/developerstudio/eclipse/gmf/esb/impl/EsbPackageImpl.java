...
public class EsbPackageImpl extends EPackageImpl implements EsbPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getInboundEndpoint_SocketTimeoutMs(), ecorePackage.getEInt(), "socketTimeoutMs", "-1", 0, 1, InboundEndpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
