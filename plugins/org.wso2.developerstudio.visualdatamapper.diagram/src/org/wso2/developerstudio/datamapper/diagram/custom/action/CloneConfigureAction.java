...
import org.wso2.developerstudio.datamapper.diagram.custom.dialogs.ConfigureCloneOperatorDialog;

public class CloneConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public CloneConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.CloneConfigureAction_ID);
		setText(Messages.CloneConfigureAction_Text);
		setToolTipText(Messages.CloneConfigureAction_ToolTip);
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureAddDialog = new ConfigureCloneOperatorDialog(Display.getDefault().getActiveShell(),
				(Clone) selectedObj, getEditingDomain());
