...
public class TemplateProjectConstants {
    ...
    public static final String JS_FUNC_SAVE_SOURCE = "saveSource();";

    public static final String JS_FUNC_IDESETDIRTY_FALSE = "IDESetDirty(false);";

    public static final String JS_FUNC_LOAD_MODEL = "loadModel();";

    public static final String JS_FUNC_MAKE_UN_DIRTY = "makeUnDirty();";
    ...
    public static final String PROJECT_MUST_BE_WRITABLE_MESSAGE = "Project must be writable";
