...
public class EditPartConstants {
    ...
    public static final String PROPERTYGROUP_MEDIATOR_ICON_PATH = "icons/ico20/propertyGroup-mediator.png";
    public static final String ENRICH_MEDIATOR_ICON_PATH = "icons/ico20/enrich-mediator.png";
    public static final String BAM_MEDIATOR_ICON_PATH = "icons/ico20/bam-mediator.png";
    ...
    public static final String COMMAND_MEDIATOR_ICON_PATH = "icons/ico20/command-mediator.png";
    public static final String CONDITIONALROUTER_MEDIATOR_ICON_PATH = "icons/ico20/conditionalRouter-mediator.png";
    public static final String CLASS_MEDIATOR_ICON_PATH = "icons/ico20/class-mediator.png";
    public static final String DATAMAPPER_MEDIATOR_ICON_PATH = "icons/ico20/datamapper-mediator.png";
    public static final String DBLOOKUP_MEDIATOR_ICON_PATH = "icons/ico20/dblookup-mediator.png";
    ...
    public static final String FAULT_MEDIATOR_ICON_PATH = "icons/ico20/fault-mediator.png";
    public static final String FILTER_MEDIATOR_ICON_PATH = "icons/ico20/filter-mediator.png";
    public static final String HEADER_MEDIATOR_ICON_PATH = "icons/ico20/header-mediator.png";
    public static final String LOOPBACK_MEDIATOR_ICON_PATH = "icons/ico20/loopBack-mediator.png";
    public static final String PUBLISHEVENT_MEDIATOR_ICON_PATH = "icons/ico20/publishevent-mediator.png";
    public static final String SWITCH_MEDIATOR_ICON_PATH = "icons/ico20/switch-mediator.png";
    public static final String VALIDATE_MEDIATOR_ICON_PATH = "icons/ico20/validate-mediator.png";
    public static final String STORE_MEDIATOR_ICON_PATH = "icons/ico20/store-mediator.png";
    public static final String SPRING_MEDIATOR_ICON_PATH = "icons/ico20/spring-mediator.png";
    public static final String SMOOKS_MEDIATOR_ICON_PATH = "icons/ico20/smooks-mediator.png";
    public static final String RESPOND_MEDIATOR_ICON_PATH = "icons/ico20/respond-mediator.png";
    ...
    public static final String DATASERVICESCALL_MEDIATOR_ICON_PATH = "icons/ico20/dataServicesCall-mediator.png";
}
