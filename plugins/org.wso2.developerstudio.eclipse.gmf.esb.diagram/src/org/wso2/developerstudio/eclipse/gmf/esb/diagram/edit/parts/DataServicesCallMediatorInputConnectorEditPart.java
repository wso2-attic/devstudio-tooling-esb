...
public class DataServicesCallMediatorInputConnectorEditPart extends AbstractMediatorInputConnectorEditPart {
    ...
    * @generated
    */
    public static final int VISUAL_ID = 3795;
    ...
    * @generated
    */
    public DataServicesCallMediatorInputConnectorEditPart(View view) {
        super(view);
    }
    ...
    */
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
                new DataServicesCallMediatorInputConnectorItemSemanticEditPolicy());
