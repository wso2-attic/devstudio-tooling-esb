...
public class EsbDiagramUpdater {
    ...
    public static List<EsbNodeDescriptor> getSemanticChildren(View view) {
        ...
        case JsonTransformMediatorEditPart.VISUAL_ID:
            return getJsonTransformMediator_3791SemanticChildren(view);
        case DataServicesCallMediatorEditPart.VISUAL_ID:
            return getDataServicesCallMediator_3794SemanticChildren(view);
    ...
    */
    public static List<EsbNodeDescriptor> getJsonTransformMediator_3791SemanticChildren(View view) {
        ...
        JsonTransformMediator modelElement = (JsonTransformMediator) view.getElement();
        LinkedList<EsbNodeDescriptor> result = new LinkedList<EsbNodeDescriptor>();
        {
            JsonTransformMediatorInputConnector childElement = modelElement.getInputConnector();
            int visualID = EsbVisualIDRegistry.getNodeVisualID(view, childElement);
            if (visualID == JsonTransformMediatorInputConnectorEditPart.VISUAL_ID) {
                result.add(new EsbNodeDescriptor(childElement, visualID));
            }
        }
        {
            JsonTransformMediatorOutputConnector childElement = modelElement.getOutputConnector();
            int visualID = EsbVisualIDRegistry.getNodeVisualID(view, childElement);
            if (visualID == JsonTransformMediatorOutputConnectorEditPart.VISUAL_ID) {
                result.add(new EsbNodeDescriptor(childElement, visualID));
            }
        }
        return result;
    ...
    * @generated
    */
    public static List<EsbNodeDescriptor> getDataServicesCallMediator_3794SemanticChildren(View view) {
        if (!view.isSetElement()) {
            return Collections.emptyList();
        }
        DataServicesCallMediator modelElement = (DataServicesCallMediator) view.getElement();
        LinkedList<EsbNodeDescriptor> result = new LinkedList<EsbNodeDescriptor>();
        {
            DataServicesCallMediatorInputConnector childElement = modelElement.getInputConnector();
            int visualID = EsbVisualIDRegistry.getNodeVisualID(view, childElement);
            if (visualID == DataServicesCallMediatorInputConnectorEditPart.VISUAL_ID) {
                result.add(new EsbNodeDescriptor(childElement, visualID));
            }
        }
        {
            DataServicesCallMediatorOutputConnector childElement = modelElement.getOutputConnector();
            int visualID = EsbVisualIDRegistry.getNodeVisualID(view, childElement);
            if (visualID == DataServicesCallMediatorOutputConnectorEditPart.VISUAL_ID) {
                result.add(new EsbNodeDescriptor(childElement, visualID));
            }
        }
        return result;
    ...
    public static List<EsbNodeDescriptor> getMediatorFlowMediatorFlowCompartment_7034SemanticChildren(View view) {
        ...
        for (Iterator<?> it = modelElement.getChildren().iterator(); it.hasNext();) {
            ...
            if (visualID == JsonTransformMediatorEditPart.VISUAL_ID) {
                result.add(new EsbNodeDescriptor(childElement, visualID));
                continue;
            }
            if (visualID == DataServicesCallMediatorEditPart.VISUAL_ID) {
                result.add(new EsbNodeDescriptor(childElement, visualID));
                continue;
            }
        }
    ...
    public static List<EsbLinkDescriptor> getContainedLinks(View view) {
        ...
        case JsonTransformMediatorEditPart.VISUAL_ID:
            return getJsonTransformMediator_3791ContainedLinks(view);
        case JsonTransformMediatorInputConnectorEditPart.VISUAL_ID:
            return getJsonTransformMediatorInputConnector_3792ContainedLinks(view);
        case JsonTransformMediatorOutputConnectorEditPart.VISUAL_ID:
            return getJsonTransformMediatorOutputConnector_3793ContainedLinks(view);
        case DataServicesCallMediatorEditPart.VISUAL_ID:
            return getDataServicesCallMediator_3794ContainedLinks(view);
        case DataServicesCallMediatorInputConnectorEditPart.VISUAL_ID:
            return getDataServicesCallMediatorInputConnector_3795ContainedLinks(view);
        case DataServicesCallMediatorOutputConnectorEditPart.VISUAL_ID:
            return getDataServicesCallMediatorOutputConnector_3796ContainedLinks(view);
        case EntitlementOnAcceptContainerEditPart.VISUAL_ID:
    ...
    public static List<EsbLinkDescriptor> getIncomingLinks(View view) {
        ...
        case JsonTransformMediatorEditPart.VISUAL_ID:
            return getJsonTransformMediator_3791IncomingLinks(view);
        case JsonTransformMediatorInputConnectorEditPart.VISUAL_ID:
            return getJsonTransformMediatorInputConnector_3792IncomingLinks(view);
        case JsonTransformMediatorOutputConnectorEditPart.VISUAL_ID:
            return getJsonTransformMediatorOutputConnector_3793IncomingLinks(view);
        case DataServicesCallMediatorEditPart.VISUAL_ID:
            return getDataServicesCallMediator_3794IncomingLinks(view);
        case DataServicesCallMediatorInputConnectorEditPart.VISUAL_ID:
            return getDataServicesCallMediatorInputConnector_3795IncomingLinks(view);
        case DataServicesCallMediatorOutputConnectorEditPart.VISUAL_ID:
            return getDataServicesCallMediatorOutputConnector_3796IncomingLinks(view);
        case EntitlementOnAcceptContainerEditPart.VISUAL_ID:
    ...
    public static List<EsbLinkDescriptor> getOutgoingLinks(View view) {
        ...
        case JsonTransformMediatorEditPart.VISUAL_ID:
            return getJsonTransformMediator_3791OutgoingLinks(view);
        case JsonTransformMediatorInputConnectorEditPart.VISUAL_ID:
            return getJsonTransformMediatorInputConnector_3792OutgoingLinks(view);
        case JsonTransformMediatorOutputConnectorEditPart.VISUAL_ID:
            return getJsonTransformMediatorOutputConnector_3793OutgoingLinks(view);
        case DataServicesCallMediatorEditPart.VISUAL_ID:
            return getDataServicesCallMediator_3794OutgoingLinks(view);
        case DataServicesCallMediatorInputConnectorEditPart.VISUAL_ID:
            return getDataServicesCallMediatorInputConnector_3795OutgoingLinks(view);
        case DataServicesCallMediatorOutputConnectorEditPart.VISUAL_ID:
            return getDataServicesCallMediatorOutputConnector_3796OutgoingLinks(view);
        case EntitlementOnAcceptContainerEditPart.VISUAL_ID:
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediator_3794ContainedLinks(View view) {
        return Collections.emptyList();
    }
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediatorInputConnector_3795ContainedLinks(View view) {
        return Collections.emptyList();
    }
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediatorOutputConnector_3796ContainedLinks(View view) {
        DataServicesCallMediatorOutputConnector modelElement = (DataServicesCallMediatorOutputConnector) view
                .getElement();
        LinkedList<EsbLinkDescriptor> result = new LinkedList<EsbLinkDescriptor>();
        result.addAll(getContainedTypeModelFacetLinks_EsbLink_4001(modelElement));
        return result;
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediator_3794IncomingLinks(View view) {
        return Collections.emptyList();
    }
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediatorInputConnector_3795IncomingLinks(View view) {
        DataServicesCallMediatorInputConnector modelElement = (DataServicesCallMediatorInputConnector) view
                .getElement();
        Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
                .find(view.eResource().getResourceSet().getResources());
        LinkedList<EsbLinkDescriptor> result = new LinkedList<EsbLinkDescriptor>();
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediatorOutputConnector_3796IncomingLinks(View view) {
        return Collections.emptyList();
    }
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediator_3794OutgoingLinks(View view) {
        return Collections.emptyList();
    }
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediatorInputConnector_3795OutgoingLinks(View view) {
        return Collections.emptyList();
    }
    ...
    * @generated
    */
    public static List<EsbLinkDescriptor> getDataServicesCallMediatorOutputConnector_3796OutgoingLinks(View view) {
        DataServicesCallMediatorOutputConnector modelElement = (DataServicesCallMediatorOutputConnector) view
                .getElement();
        LinkedList<EsbLinkDescriptor> result = new LinkedList<EsbLinkDescriptor>();
        result.addAll(getOutgoingTypeModelFacetLinks_EsbLink_4001(modelElement));
