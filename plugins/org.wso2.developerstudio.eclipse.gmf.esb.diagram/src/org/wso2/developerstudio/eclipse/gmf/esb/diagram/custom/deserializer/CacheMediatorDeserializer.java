...
import static org.wso2.developerstudio.eclipse.gmf.esb.EsbPackage.Literals.CACHE_MEDIATOR__CACHE_TYPE;
...
import static org.wso2.developerstudio.eclipse.gmf.esb.EsbPackage.Literals.CACHE_MEDIATOR__ID;
import static org.wso2.developerstudio.eclipse.gmf.esb.EsbPackage.Literals.CACHE_MEDIATOR__HASH_GENERATOR_ATTRIBUTE;
import static org.wso2.developerstudio.eclipse.gmf.esb.EsbPackage.Literals.CACHE_MEDIATOR__SCOPE;
import static org.wso2.developerstudio.eclipse.gmf.esb.EsbPackage.Literals.CACHE_MEDIATOR__IMPLEMENTATION_TYPE;
import static org.wso2.developerstudio.eclipse.gmf.esb.EsbPackage.Literals.CACHE_MEDIATOR__CACHE_MEDIATOR_IMPLEMENTATION;
			...
			if (mediator.isCollector()) {
				...
				if (!mediator.isPreviousCacheImplementation()) {
					...
					if (mediator.getHashGenerator() != null) {
					    ...
					    executeSetValueCommand(CACHE_MEDIATOR__HASH_GENERATOR_ATTRIBUTE, "org.wso2.carbon.mediator.cache.digest.DOMHASHGenerator");
					}
					if (mediator.getScope() != null && mediator.getScope().equals("per-mediator")) {
						executeSetValueCommand(CACHE_MEDIATOR__SCOPE, CacheScopeType.PER_MEDIATOR);
					} else {
