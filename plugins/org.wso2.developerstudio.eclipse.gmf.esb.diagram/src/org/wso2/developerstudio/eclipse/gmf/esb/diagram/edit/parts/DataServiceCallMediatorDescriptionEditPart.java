 ...
 * @generated
 */
public class DataServiceCallMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public DataServiceCallMediatorDescriptionEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.DataServiceCallMediator_3791, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DataServiceCallMediatorDescriptionEditPart.VISUAL_ID));
        }
        return parser;
    }
