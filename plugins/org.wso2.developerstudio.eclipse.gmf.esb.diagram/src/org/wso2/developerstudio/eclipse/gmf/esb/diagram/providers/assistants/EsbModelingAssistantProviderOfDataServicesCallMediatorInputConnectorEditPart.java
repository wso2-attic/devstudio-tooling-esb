 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfDataServicesCallMediatorInputConnectorEditPart
    ...
    */
    ...
    public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
        ...
        return doGetRelTypesOnTarget((DataServicesCallMediatorInputConnectorEditPart) targetEditPart);
    }

    /**
    * @generated
    */
    public List<IElementType> doGetRelTypesOnTarget(DataServicesCallMediatorInputConnectorEditPart target) {
    ...
    */
    ...
    public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
        IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
        return doGetTypesForSource((DataServicesCallMediatorInputConnectorEditPart) targetEditPart, relationshipType);
    }

    /**
    * @generated
    */
    public List<IElementType> doGetTypesForSource(DataServicesCallMediatorInputConnectorEditPart target,
