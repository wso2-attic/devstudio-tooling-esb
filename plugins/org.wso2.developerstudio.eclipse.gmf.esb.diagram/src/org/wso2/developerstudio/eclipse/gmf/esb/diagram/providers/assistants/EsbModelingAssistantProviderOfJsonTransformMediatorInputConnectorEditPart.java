 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfJsonTransformMediatorInputConnectorEditPart
    ...
    */
    ...
    public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
        ...
        return doGetRelTypesOnTarget((JsonTransformMediatorInputConnectorEditPart) targetEditPart);
    }
    ...
    */
    ...
    public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
        IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
        return doGetTypesForSource((JsonTransformMediatorInputConnectorEditPart) targetEditPart, relationshipType);
    }
