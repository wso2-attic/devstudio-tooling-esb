...
public class TemplateEndpointDeserializer extends AbstractEsbNodeDeserializer<AbstractEndpoint, AbstractEndPoint> {
	...
	public void createNode(FormEditor formEditor, AbstractEndpoint endpointObject) {
		...
		if (templateEndpoint.getVersion() != null) {
			templateEndpointPage.setVersion(templateEndpoint.getVersion());
		}
		...
		if (keySet != null) {
			...
			templateEndpointPage.templateParameterList = getTemplateEndpointParameter(keySet,parameterMap,existingProperties);
		}else {
