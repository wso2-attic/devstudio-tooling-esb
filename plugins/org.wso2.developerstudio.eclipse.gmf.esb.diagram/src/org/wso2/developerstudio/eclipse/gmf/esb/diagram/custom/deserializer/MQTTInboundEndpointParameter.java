...
/**
 * This Enum represent MQTT inbound endpoint parameters with parameter name , related EAttribute and boolean value indicating
...
public enum MQTTInboundEndpointParameter {
    ...
    INBOUND_MQTT_SSL_KEYSTORE_LOCATION(InboundEndpointConstants.INBOUND_MQTT_SSL_KEYSTORE_LOCATION,
    		INBOUND_ENDPOINT__TRANSPORT_MQTT_SSL_KEY_STORE_LOCATION, false),
    INBOUND_MQTT_SSL_KEYSTORE_TYPE(InboundEndpointConstants.INBOUND_MQTT_SSL_KEYSTORE_TYPE,
    		INBOUND_ENDPOINT__TRANSPORT_MQTT_SSL_KEYSTORE_TYPE, false),
    INBOUND_MQTT_SSL_KEYSTORE_PASSWORD(InboundEndpointConstants.INBOUND_MQTT_SSL_KEYSTORE_PASSWORD,
    		INBOUND_ENDPOINT__TRANSPORT_MQTT_SSL_KEYSTORE_PASSWORD, false),
    INBOUND_MQTT_SSL_TRUSTSTORE_LOCATION(InboundEndpointConstants.INBOUND_MQTT_SSL_TRUSTSTORE_LOCATION,
    		INBOUND_ENDPOINT__TRANSPORT_MQTT_SSL_TRUSTSTORE_LOCATION, false),
    INBOUND_MQTT_SSL_TRUSTSTORE_TYPE(InboundEndpointConstants.INBOUND_MQTT_SSL_TRUSTSTORE_TYPE,
    		INBOUND_ENDPOINT__TRANSPORT_MQTT_SSL_TRUSTSTORE_TYPE, false),
    INBOUND_MQTT_SSL_TRUSTSTORE_PASSWORD(InboundEndpointConstants.INBOUND_MQTT_SSL_TRUSTSTORE_PASSWORD,
    		INBOUND_ENDPOINT__TRANSPORT_MQTT_SSL_TRUSTSTORE_PASSWORD, false),
    INBOUND_MQTT_SSL_VERSION(InboundEndpointConstants.INBOUND_MQTT_SSL_VERSION,
    		INBOUND_ENDPOINT__TRANSPORT_MQTT_SSL_VERSION, false);
