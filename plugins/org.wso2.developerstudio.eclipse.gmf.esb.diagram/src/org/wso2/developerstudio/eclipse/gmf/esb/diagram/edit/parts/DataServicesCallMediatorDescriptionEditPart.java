 ...
 * @generated
 */
public class DataServicesCallMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    * @generated
    */
    public DataServicesCallMediatorDescriptionEditPart(View view) {
        super(view);
    }
    ...
    */
    public IParser getParser() {
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.DataServicesCallMediator_3794, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.DataServicesCallMediatorDescriptionEditPart.VISUAL_ID));
        }
        return parser;
    }
