...
public class EsbVisualIDRegistry {
    ...
    public static int getNodeVisualID(View containerView, EObject domainElement) {
        ...
        case DataServiceCallMediatorEditPart.VISUAL_ID:
            if (EsbPackage.eINSTANCE.getDataServiceCallMediatorInputConnector().isSuperTypeOf(domainElement.eClass())) {
                return DataServiceCallMediatorInputConnectorEditPart.VISUAL_ID;
            }
            if (EsbPackage.eINSTANCE.getDataServiceCallMediatorOutputConnector()
                    .isSuperTypeOf(domainElement.eClass())) {
                return DataServiceCallMediatorOutputConnectorEditPart.VISUAL_ID;
            }
            break;
        ...
        case MediatorFlowMediatorFlowCompartment23EditPart.VISUAL_ID:
            mediatorFlowMediatorFlowCompartment23EditPart(domainElement);
            break;
        case MediatorFlowMediatorFlowCompartment24EditPart.VISUAL_ID:
            mediatorFlowMediatorFlowCompartment24EditPart(domainElement);
            break;
        ...
        case MediatorFlowMediatorFlowCompartment25EditPart.VISUAL_ID:
            mediatorFlowMediatorFlowCompartment25EditPart(domainElement);
            break;
    ...
    private static int mediatorFlowMediatorFlowCompartment23EditPart(EObject domainElement) {
        if (EsbPackage.eINSTANCE.getDropMediator().isSuperTypeOf(domainElement.eClass())) {
            return DropMediatorEditPart.VISUAL_ID;
        }
        if (EsbPackage.eINSTANCE.getPropertyMediator().isSuperTypeOf(domainElement.eClass())) {
    ...
    private static int mediatorFlowMediatorFlowCompartment24EditPart(EObject domainElement) {
        if (EsbPackage.eINSTANCE.getDropMediator().isSuperTypeOf(domainElement.eClass())) {
            return DropMediatorEditPart.VISUAL_ID;
        }
        if (EsbPackage.eINSTANCE.getPropertyMediator().isSuperTypeOf(domainElement.eClass())) {
    ...
    private static int mediatorFlowMediatorFlowCompartment25EditPart(EObject domainElement) {
        if (EsbPackage.eINSTANCE.getDropMediator().isSuperTypeOf(domainElement.eClass())) {
            return DropMediatorEditPart.VISUAL_ID;
        }
        if (EsbPackage.eINSTANCE.getPropertyMediator().isSuperTypeOf(domainElement.eClass())) {
    ...
    public static boolean canCreateNode(View containerView, int nodeVisualID) {
        ...
        case LogMediatorEditPart.VISUAL_ID:
            ...
            break;
        case DataServiceCallMediatorEditPart.VISUAL_ID:
            if (DataServiceCallMediatorDescriptionEditPart.VISUAL_ID == nodeVisualID) {
                return true;
            }
            if (DataServiceCallMediatorInputConnectorEditPart.VISUAL_ID == nodeVisualID) {
                return true;
            }
            if (DataServiceCallMediatorOutputConnectorEditPart.VISUAL_ID == nodeVisualID) {
                return true;
            }
            break;
        case EnrichMediatorEditPart.VISUAL_ID:
        ...
        case MediatorFlowMediatorFlowCompartmentEditPart.VISUAL_ID:
            ...
            if (DataServiceCallMediatorEditPart.VISUAL_ID == nodeVisualID) {
                return true;
            }
