 ...
 * 
 */
public class DataServicesCallMediatorOutputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DataServicesCallMediatorOutputConnectorPropertiesEditionPart {
	 ...
	 */
	public DataServicesCallMediatorOutputConnectorPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public DataServicesCallMediatorOutputConnectorPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EsbMessages.DataServicesCallMediatorOutputConnectorPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createCommentMediatorsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.commentMediators = new ReferencesTable(getDescription(EsbViewsRepository.DataServicesCallMediatorOutputConnector.Properties.commentMediators, EsbMessages.DataServicesCallMediatorOutputConnectorPropertiesEditionPart_CommentMediatorsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataServicesCallMediatorOutputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.DataServicesCallMediatorOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				commentMediators.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataServicesCallMediatorOutputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.DataServicesCallMediatorOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				commentMediators.refresh();
			}
		...
		this.commentMediators.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.DataServicesCallMediatorOutputConnector.Properties.commentMediators, EsbViewsRepository.FORM_KIND));
