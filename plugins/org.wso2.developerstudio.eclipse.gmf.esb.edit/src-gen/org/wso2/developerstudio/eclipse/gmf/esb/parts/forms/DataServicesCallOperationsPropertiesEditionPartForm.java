 ...
 * 
 */
public class DataServicesCallOperationsPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DataServicesCallOperationsPropertiesEditionPart {
	 ...
	 */
	public DataServicesCallOperationsPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public DataServicesCallOperationsPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EsbMessages.DataServicesCallOperationsPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createOperationNameText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DataServicesCallOperationsPropertiesEditionPartForm.this,
							EsbViewsRepository.DataServicesCallOperations.Properties.operationName,
		...
		operationName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataServicesCallOperationsPropertiesEditionPartForm.this, EsbViewsRepository.DataServicesCallOperations.Properties.operationName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, operationName.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DataServicesCallOperations.Properties.operationName, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
