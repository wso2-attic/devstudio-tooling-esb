...
public class CacheMediatorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		...
		if (cacheMediator.getCacheType().equals(CacheType.FINDER)) {
			...
			if (cacheMediator.getCacheMediatorImplementation().equals(CacheMediatorType.NEW_IMPLEMENTATION)) {
		...
		} else if (cacheMediator.getCacheMediatorImplementation().equals(CacheMediatorType.PREVIOUS_IMPLEMENTATION)) {
			addScopePropertyDescriptor(object);
		}
