...
public class JsonTransformMediatorItemProvider extends MediatorItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(EsbPackage.Literals.JSON_TRANSFORM_MEDIATOR__INPUT_CONNECTOR);
            childrenFeatures.add(EsbPackage.Literals.JSON_TRANSFORM_MEDIATOR__OUTPUT_CONNECTOR);
            childrenFeatures.add(EsbPackage.Literals.JSON_TRANSFORM_MEDIATOR__SCHEMA);
        }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/JsonTransformMediator.png"));
    }
