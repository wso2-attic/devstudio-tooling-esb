...
public class MessageProcessorList extends AbstractListDataProvider{

	@Override
	public List<ListData> getListData(String modelProperty,ProjectDataModel model) {
		List<ListData> list = new ArrayList<ListData>();
		List<OMElement> availableSeqList = ((MessageProcessorModel)model).getAvailableProcessorlist();
